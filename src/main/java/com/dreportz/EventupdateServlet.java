...
public class EventupdateServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // Call the 'updatereport' method to update event details and store the result
        isTrue = ReportDBUtil.updatereport(id, name, event_type, participant_limit, time_period, instruction, assign_organizer, assign_coordinator);
